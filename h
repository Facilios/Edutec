...
DDEESSCCRRIIPPTTIIOONN
       ...
       When neither the command-line nor the configuration specifies what to push, the default behavior is used,
...
OOPPTTIIOONNSS
       <repository>
           The "remote" repository that is the destination of a push operation. This parameter can be either a URL
       ...
       --no-recurse-submodules, --recurse-submodules=check|on-demand|only|no
           ...
           submodules will be pushed while the superproject is left unpushed. A value of _n_o or using
           ...
           When using _o_n_-_d_e_m_a_n_d or _o_n_l_y, if a submodule has a "push.recurseSubmodules={on-demand,only}" or
           "submodule.recurse" configuration, further recursion will occur. In this case, "only" is treated as
           "on-demand".
...
GGIITT UURRLLSS
       ...
       •   sssshh::////[_<_u_s_e_r_>@@]_<_h_o_s_t_>[::_<_p_o_r_t_>]//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       •   ggiitt::////_<_h_o_s_t_>[:_<_p_o_r_t_>]//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       •   hhttttpp[ss]::////_<_h_o_s_t_>[::_<_p_o_r_t_>]//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       •   ffttpp[ss]::////_<_h_o_s_t_>[::_<_p_o_r_t_>]//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       An alternative scp-like syntax may also be used with the ssh protocol:

       •   [_<_u_s_e_r_>@@]_<_h_o_s_t_>:://_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>
       ...
       The ssh and git protocols additionally support ~~_<_u_s_e_r_n_a_m_e_> expansion:

       •   sssshh::////[_<_u_s_e_r_>@@]_<_h_o_s_t_>[::_<_p_o_r_t_>]//~~_<_u_s_e_r_>//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       •   ggiitt::////_<_h_o_s_t_>[::_<_p_o_r_t_>]//~~_<_u_s_e_r_>//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       •   [_<_u_s_e_r_>@@]_<_h_o_s_t_>::~~_<_u_s_e_r_>//_<_p_a_t_h_-_t_o_-_g_i_t_-_r_e_p_o_>

       For local repositories, also supported by Git natively, the following syntaxes may be used:

       •   //ppaatthh//ttoo//rreeppoo..ggiitt//

       •   ffiillee:://////ppaatthh//ttoo//rreeppoo..ggiitt//

       These two syntaxes are mostly equivalent, except when cloning, when the former implies ----llooccaall option. See
       ggiitt--cclloonnee(1) for details.

       ggiitt cclloonnee, ggiitt ffeettcchh and ggiitt ppuullll, but not ggiitt ppuusshh, will also accept a suitable bundle file. See ggiitt--
       bbuunnddllee(1).

       When Git doesn’t know how to handle a certain transport protocol, it attempts to use the rreemmoottee--_<_t_r_a_n_s_p_o_r_t_>
       ...
       where _<_a_d_d_r_e_s_s_> may be a path, a server and path, or an arbitrary URL-like string recognized by the
       ...
       section of the form:
                   ...
                   [url "_<_a_c_t_u_a_l_-_u_r_l_-_b_a_s_e_>"]
                           insteadOf = _<_o_t_h_e_r_-_u_r_l_-_b_a_s_e_>
       ...
       If you want to rewrite URLs for push only, you can create a configuration section of the form:
                   ...
                   [url "_<_a_c_t_u_a_l_-_u_r_l_-_b_a_s_e_>"]
                           pushInsteadOf = _<_o_t_h_e_r_-_u_r_l_-_b_a_s_e_>
...
RREEMMOOTTEESS
   ...
   NNaammeedd rreemmoottee iinn ccoonnffiigguurraattiioonn ffiillee
       ...
       The <<ppuusshhuurrll>> is used for pushes only. It is optional and defaults to <<UURRLL>>. Pushing to a remote affects
       all defined pushurls or all defined urls if no pushurls are defined. Fetch, however, will only fetch from
...
CCOONNFFIIGGUURRAATTIIOONN
       Everything below this line in this section is selectively included from the ggiitt--ccoonnffiigg(1) documentation.
       The content is the same as what’s found there:

       push.autoSetupRemote
           If set to "true" assume ----sseett--uuppssttrreeaamm on default push when no upstream tracking exists for the current
           branch; this option takes effect with push.default options _s_i_m_p_l_e, _u_p_s_t_r_e_a_m, and _c_u_r_r_e_n_t. It is useful
           if by default you want new branches to be pushed to the default remote (like the behavior of
           _p_u_s_h_._d_e_f_a_u_l_t_=_c_u_r_r_e_n_t) and you also want the upstream tracking to be set. Workflows most likely to
           benefit from this option are _s_i_m_p_l_e central workflows where all branches are expected to have the same
           name on the remote.

       push.default
           Defines the action ggiitt ppuusshh should take if no refspec is given (whether from the command-line, config,
           or elsewhere). Different values are well-suited for specific workflows; for instance, in a purely
           central workflow (i.e. the fetch source is equal to the push destination), uuppssttrreeaamm is probably what
           you want. Possible values are:

           •   nnootthhiinngg - do not push anything (error out) unless a refspec is given. This is primarily meant for
               people who want to avoid mistakes by always being explicit.

           •   ccuurrrreenntt - push the current branch to update a branch with the same name on the receiving end. Works
           ...
           •   uuppssttrreeaamm - push the current branch back to the branch whose changes are usually integrated into the
               current branch (which is called @@{{uuppssttrreeaamm}}). This mode only makes sense if you are pushing to the
           ...
           •   ssiimmppllee - push the current branch with the same name on the remote.

               If you are working on a centralized workflow (pushing to the same repository you pull from, which
               is typically oorriiggiinn), then you need to configure an upstream branch with the same name.
           ...
           •   mmaattcchhiinngg - push all branches having the same name on both ends. This makes the repository you are
               ...
               _m_a_s_t_e_r there and no other branches, the repository you push to will have these two branches, and
               your local _m_a_i_n_t and _m_a_s_t_e_r will be pushed there).

               To use this mode effectively, you have to make sure _a_l_l the branches you would push out are ready
               to be pushed out before running _g_i_t _p_u_s_h, as the whole point of this mode is to allow you to push
       ...
       push.followTags
           If set to true, enable ----ffoollllooww--ttaaggss option by default. You may override this configuration at time of
           push by specifying ----nnoo--ffoollllooww--ttaaggss.

       push.gpgSign
           May be set to a boolean value, or the string _i_f_-_a_s_k_e_d. A true value causes all pushes to be GPG signed,
           as if ----ssiiggnneedd is passed to ggiitt--ppuusshh(1). The string _i_f_-_a_s_k_e_d causes pushes to be signed if the server
           supports it, as if ----ssiiggnneedd==iiff--aasskkeedd is passed to _g_i_t _p_u_s_h. A false value may override a value from a
           lower-priority config file. An explicit command-line flag always overrides this config option.

       push.pushOption
           When no ----ppuusshh--ooppttiioonn==<<ooppttiioonn>> argument is given from the command line, ggiitt ppuusshh behaves as if each
           <value> of this variable is given as ----ppuusshh--ooppttiioonn==<<vvaalluuee>>.

           This is a multi-valued variable, and an empty value can be used in a higher priority configuration file
           (e.g.  ..ggiitt//ccoonnffiigg in a repository) to clear the values inherited from a lower priority configuration
           files (e.g.  $$HHOOMMEE//..ggiittccoonnffiigg).
       ...
       push.recurseSubmodules
           ...
           --recurse-submodules". If not set, _n_o is used by default, unless _s_u_b_m_o_d_u_l_e_._r_e_c_u_r_s_e is set (in which
           case a _t_r_u_e value means _o_n_-_d_e_m_a_n_d).

       push.useForceIfIncludes
           If set to "true", it is equivalent to specifying ----ffoorrccee--iiff--iinncclluuddeess as an option to ggiitt--ppuusshh(1) in the
           command line. Adding ----nnoo--ffoorrccee--iiff--iinncclluuddeess at the time of push overrides this configuration setting.

       push.negotiate
           If set to "true", attempt to reduce the size of the packfile sent by rounds of negotiation in which the
           client and the server attempt to find commits in common. If "false", Git will rely solely on the
           server’s ref advertisement to find commits in common.

       push.useBitmaps
           If set to "false", disable use of bitmaps for "git push" even if ppaacckk..uusseeBBiittmmaappss is "true", without
           preventing other git operations from using bitmaps. Default is true.

GGIITT
       Part of the ggiitt(1) suite

Git 2.45.2                                          05/31/2024                                         GIT-PUSH(1)
